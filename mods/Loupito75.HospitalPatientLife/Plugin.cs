...
namespace HospitalPatientLife
{
    ...
    {
        public const string PluginGuid = "loupito75.HospitalPatientLife";
        ...
        private void Awake()
        {
            ...
            HospitalPatientLifeConfig.Load();
            ...
            catch (Exception exception)
            {
                ...
                Log.LogError(
                    PluginName + " could not apply its Harmony patches and was disabled: " +
